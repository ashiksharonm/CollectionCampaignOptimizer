...
class Explainer:
    ...
    def explain_prediction(self, context: np.ndarray, action: Channel) -> Dict[str, Any]:
        ...
        feat_names = self.transformer.get_feature_names() + ["ACTION_SMS", "ACTION_CALL", "ACTION_FIELD"]
