...
# Global State
model_state = {"policy": None, "transformer": None, "explainer": None, "ready": False}
...
async def startup_event():
    ...
    _ = trainer.train(policy, n_rounds=WARMUP_ROUNDS)

    # Train Explainer
    explainer = Explainer(transformer)

    # Generate fresh data for explainer
    # We need to reconstruct context list from it?
